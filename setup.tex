...
\sjtusetup{
  ...
  info = {%
    ...
    % 标题
    %
    title           = {利用PandaX-4T探测器探测自相互作用暗物质},
    title*          = {A search for self-interacting dark matter using PandaX-4T detector},
    %
    % 标题页标题
    %   可使用“\\”命令手动控制换行
    %
    ...
    % 关键词
    %
    keywords        = {暗物质，直接探测，两相型氙时间投影室，PandaX-4T实验},
    keywords*       = {Dark matter, direct detection, dual-phase xenon time projection chamber, PandaX-4T experiment},
    %
    % 姓名
    %
    author          = {黄\quad{}迪},
